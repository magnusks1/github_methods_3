...
# Could be an option to elaborate on the descriptions of the variables — to get a better understanding of what to do in the exercises. E.g. use length(unique(variable)) to see e.g. how many subjects there are.  
...
# Always good to factorize non-numeric variables to make R treat them correctly.
glimpse(politeness)
